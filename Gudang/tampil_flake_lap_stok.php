...
$sql="select f_awal as Flake_Awal,d.jumlah_olah as Flake_Masuk,f_awal+jumlah_olah as Flake_akhir from pengolahan p,detil_pengolahan d where d.id_brg='3' and d.tgl_pengolahan=p.tgl_pengolahan and d.id_pengolahan=p.id_pengolahan and date_format(p.tgl_pengolahan,'%Y-%m')='$tgl_pengolahan' order by p.tgl_pengolahan";
