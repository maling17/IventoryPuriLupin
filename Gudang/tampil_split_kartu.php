...
$sql_tampil_mitra="select s_awal as Split_Awal,jumlah_olah as S_Olah,s_awal+jumlah_olah as Split_akhir from pengolahan p,detil_pengolahan d where d.id_brg='2' and d.tgl_pengolahan=p.tgl_pengolahan and d.id_pengolahan=p.id_pengolahan order by p.tgl_pengolahan;";
